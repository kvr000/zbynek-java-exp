 ...
 * 	Zbyněk Vyškovský
 */
public class SecondaryIndexExperiment extends TableExperimentBase {
	private static final String tableName = "ZbynekSecondary";

	Table table;

	public static void main(String[] args) {
		System.exit(new SecondaryIndexExperiment().run(args));
	}
