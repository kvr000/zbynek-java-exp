 ...
 */
@Log4j2
public class RabbitMqReactorPublishReceive
{
	private final String rabbitMqUrl = "localhost:5672";

	public static void main(String[] args) throws Exception
	{
		System.exit(new RabbitMqReactorPublishReceive().run(args));
	}
	...
	public void publishTest() throws Exception
	{
		...
		try (RabbitMqReactorCommon rabbitMqCommon = setupRabbitMq()) {

			CountDownLatch latch = new CountDownLatch(3);

			RabbitMqReactorCommon.Subscription subscription = rabbitMqCommon.createSubscription(new RedisConnectionStateAdapter() {
				@Override
			...
			RabbitMqReactorCommon.Publisher publisher = rabbitMqCommon.getPublisher(new RedisConnectionStateAdapter()
			{
				@Override
				public void onRedisConnected(RedisChannelHandler<?, ?> connection, SocketAddress socketAddress)
				{
	...
	public RabbitMqReactorCommon setupRabbitMq()
	{
		return new RabbitMqReactorCommon(rabbitMqUrl);
	}
